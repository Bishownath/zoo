...
if($_POST['editOf'] == ''){
		$insert_cat= $pdo->prepare("INSERT INTO classification_tbl (name) VALUES (:name)");  
	...
	$update_cat = $pdo->prepare("UPDATE classification_tbl SET name=:name WHERE id=:id"); 
...
<main style="width: 50vw; margin:80px;">
 ...
 <form method="POST">
  ...
  <div class="form-group">
    <h2 style="color: #00af;">Add Classification</h2><br><br>
